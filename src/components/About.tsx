  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          <p className="mb-4 text-[10px] uppercase tracking-[0.28em] text-white/50 sm:text-xs sm:tracking-[0.3em]">
        ...
        <div className="grid gap-14 sm:gap-16 lg:grid-cols-[1.2fr_0.8fr] lg:gap-20">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-sm leading-relaxed text-white/60 sm:mt-8 sm:text-base">
            ...
            <p className="mt-5 max-w-2xl text-sm leading-relaxed text-white/60 sm:mt-6 sm:text-base">
          ...
          >
            <div className="border-t border-white/10 pt-5 sm:pt-6">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-x-3 gap-y-2 text-xs text-white/50 sm:mt-6 sm:gap-4 sm:text-sm">
                <span>2019 — 2023</span>
                <span>·</span>
